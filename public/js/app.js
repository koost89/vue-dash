...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0), __webpack_require__(35).setImmediate))
...
var hasCORS = __webpack_require__(78);
...
var eio = __webpack_require__(76);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__store_index__ = __webpack_require__(102);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__views_App__ = __webpack_require__(56);
...
window.io = __webpack_require__(71);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__store_index__ = __webpack_require__(102);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    }), Object(__WEBPACK_IMPORTED_MODULE_2_vuex__["b" /* mapGetters */])('auth', {
    ...
    methods: {
        ...
        attemptRefresh: function attemptRefresh() {
            ...
            return new Promise(function (resolve, reject) {
                ...
                _this2.$store.dispatch('auth/refresh', token).then(function (response) {
    ...
    created: function created() {
        ...
        this.$http.interceptors.request.use(function (config) {
            return new Promise(function (resolve, reject) {
                var tokenTime = parseInt(localStorage.getItem('expires_at'), 10);
                var currentTime = parseInt(new Date().getTime(), 10);
                var refreshTime = parseInt(tokenTime - 10 * 1000, 10);

                var tokenIsExpiringSoon = currentTime > refreshTime;
                console.log('token expiring soon: ' + tokenIsExpiringSoon);

                if (tokenIsExpiringSoon && _this3.authStatus !== 'loading') {
                    _this3.attemptRefresh().then(function () {
                        console.log('returning resolveded config');
                        config.headers['Authorization'] = 'Bearer ' + _this3.token;
                        resolve(config);
                    }).catch(function () {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__views_Login__ = __webpack_require__(62);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__views_Home__ = __webpack_require__(65);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__views_Test__ = __webpack_require__(68);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__store_index__ = __webpack_require__(102);
...
var router = new __WEBPACK_IMPORTED_MODULE_1_vue_router__["a" /* default */]({
    ...
    routes: [{
        ...
        path: '/test',
        name: 'test',
        component: __WEBPACK_IMPORTED_MODULE_4__views_Test___default.a
    }]
});

router.beforeEach(function (to, from, next) {
    if (!__WEBPACK_IMPORTED_MODULE_5__store_index__["a" /* default */].getters['auth/isLoggedIn'] && to.name !== 'login') {
        next('/');
        return;
    }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        login: function login() {
            ...
            var _self = this;
            this.$store.dispatch('auth/login', { email: email, password: password }).then(function () {
...
/* harmony default export */ __webpack_exports__["default"] = ({
    created: function created() {
        ...
        this.$http.get('/user').then(function (response) {
            _this.$store.dispatch('user/fetchedUser', response.data);
        }).catch(function (error) {
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-b28ce99e", Component.options)
  } else {
    hotAPI.reload("data-v-b28ce99e", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("p", [_vm._v("This is A TEST")])
}
var staticRenderFns = []
render._withStripped = true
module.exports = { render: render, staticRenderFns: staticRenderFns }
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-b28ce99e", module.exports)
  }
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__modules_auth__ = __webpack_require__(103);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__modules_user__ = __webpack_require__(104);
...
var actions = {
    login: function login(_ref, user) {
        ...
        return new Promise(function (resolve, reject) {
            commit('auth_request');
            __WEBPACK_IMPORTED_MODULE_0_axios___default()({ url: 'http://geldhark.kevin/login', data: user, method: 'POST' }).then(function (resp) {

                var token = resp.data.access_token;
                var expires_in = resp.data.expires_in;
    ...
    refresh: function refresh(_ref2, token) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            __WEBPACK_IMPORTED_MODULE_0_axios___default()({ url: 'http://geldhark.kevin/login/refresh', method: 'POST' }).then(function (resp) {
    ...
    logout: function logout(_ref3) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            localStorage.removeItem('expires_in');
            localStorage.removeItem('expires_at');
            delete __WEBPACK_IMPORTED_MODULE_1_vue___default.a.prototype.$http.defaults.headers.common['Authorization'];
            resolve();
        });
    }
};
var mutations = {
    ...
    refresh_request: function refresh_request(state) {
        state.status = 'loading';
    },
    refresh_success: function refresh_success(state, token) {
        state.status = 'success';
        state.token = token;
    },
    refresh_error: function refresh_error(state) {
        state.status = 'error';
    },
...
var actions = {
    fetchedUser: function fetchedUser(_ref, user) {
        var commit = _ref.commit;
...
var mutations = {
    user_fetched: function user_fetched(state, user) {
        state.user = user;
    }
};
